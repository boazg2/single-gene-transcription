...
# repeat for the far to moderate barrier transition:

far_weak_low_reduction <- weak_far_df %>%
  inner_join(weak_mod_low_df, by = c("lansG", "lansT"), suffix = c("_far", "_mod_low")) %>%
  transmute(
    lansG = lansG,
    lansT = lansT,
    mod_rate = mean_rate_far,
    close_low_rate = mean_rate_mod_low,
    reduction = log2(close_low_rate / mod_rate)
  )
far_mod_low_reduction <- mod_far_df %>%
  inner_join(mod_mod_low_df, by = c("lansG", "lansT"), suffix = c("_far", "_mod_low")) %>%
  transmute(
    lansG = lansG,
    lansT = lansT,
    mod_rate = mean_rate_far,
...
far_strong_low_reduction <- strong_far_df %>%
  inner_join(strong_mod_low_df, by = c("lansG", "lansT"), suffix = c("_far", "_mod_low")) %>%
  transmute(
    lansG = lansG,
    lansT = lansT,
    mod_rate = mean_rate_far,
...
get_transcription_grid_tricolor(far_weak_low_reduction, 
                       plot_title = "weak 100 kb to weak 10 kb low topo", 
                       fillvar = "reduction",
                       x_label = "Gyrase Activity (Lk/kb/s)",
                       y_label = "TopoI Activity (Lk/kb/s)",
                       fill_label = "Log2 Fold Change",
                       ...
                       opt_y = opt_top/10) +
  theme_classic()
get_transcription_grid_tricolor(far_mod_low_reduction, 
                       plot_title = "mod 100 kb to mod 10 kb low topo", 
                       fillvar = "reduction",
                       x_label = "Gyrase Activity (Lk/kb/s)",
                       y_label = "TopoI Activity (Lk/kb/s)",
                       fill_label = "Log2 Fold Change",
                       ...
                       opt_y = opt_top/10) +
  theme_classic()
get_transcription_grid_tricolor(far_strong_low_reduction, 
                       plot_title = "strong 100 kb to strong 10 kb low topo", 
                       fillvar = "reduction",
                       x_label = "Gyrase Activity (Lk/kb/s)",
                       y_label = "TopoI Activity (Lk/kb/s)",
                       fill_label = "Log2 Fold Change",
...
get_transcription_grid_tricolor(far_weak_reduction, 
                       plot_title = "weak 100 kb to weak 10 kb", 
                       fillvar = "reduction",
                       x_label = "Gyrase Activity (Lk/kb/s)",
                       y_label = "TopoI Activity (Lk/kb/s)",
                       fill_label = "Log2 Fold Change",
...
get_transcription_grid_tricolor(far_mod_reduction, 
                       plot_title = "mod 100 kb to mod 10 kb", 
                       fillvar = "reduction",
                       x_label = "Gyrase Activity (Lk/kb/s)",
                       y_label = "TopoI Activity (Lk/kb/s)",
                       fill_label = "Log2 Fold Change",
...
get_transcription_grid_tricolor(far_strong_reduction, 
                       plot_title = "strong 100 kb to strong 10 kb", 
                       fillvar = "reduction",
                       x_label = "Gyrase Activity (Lk/kb/s)",
                       y_label = "TopoI Activity (Lk/kb/s)",
                       fill_label = "Log2 Fold Change",
